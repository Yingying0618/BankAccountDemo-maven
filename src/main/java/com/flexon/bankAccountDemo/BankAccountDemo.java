...
public class BankAccountDemo {
    public static void main(String[] args) {
        ...
        BankAccountDemo bankAccountDemo = new BankAccountDemo();
        System.out.println("Welcome!");
        System.out.println("Are you a new user with us?");
        System.out.println("Please enter \"yes\", \"no\", or \"exit\" ");
        bankAccountDemo.response(account1);
    }

    protected void response(BankAccount account1){
        ...
        while (true) {
            ...
            if (answer.equals("yes")) {
                ...
                selectFunction(account1, scanner);
    ...
    protected static void selectFunction(BankAccount account, Scanner scanner){
        ...
        while (!answer.equals("exit")) {
            ...
            if (answer.equals("deposit")) {
                ...
                account.deduct(scanner.nextInt(), account.getBalance());
                //break;
            } else if (answer.equals("exit")) {
                BankAccountDemo demo=new BankAccountDemo();
                demo.exit(answer);
...
class BankAccount {
    ...
    public double add(double deposit){
        if (deposit >= 0){
    ...
    public double deduct(double withdraw, double balance){
